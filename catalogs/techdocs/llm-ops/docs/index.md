...
In this exercise, you'll learn to automate the build, evaluation, and deployment of your LLM application. We'll use the [**LLMOps**] as a guide for deploying an LLM with **Prompt Flow** and **Gitlab Pipeline Trigger**. This automation is vital for VP, enabling efficient, error-free deployment processes for their 24/7 support virtual agent.

By mastering these tasks, VP's team will boost their ability to manage AI prompt independently, ensuring smooth operations and maximizing the benefits of AI services for their healthcare solutions.

### Exercise Steps

1. [Bootstrapping a New Project](./bootstrapping.md)
2. [Delivering a New Feature](./delivering_new_feature.md)
